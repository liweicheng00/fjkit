...
def jobs_page(service: JobServiceDep) -> JobsResponse:
...
@render("jobs/_jobs.html")
def clear_finished(service: JobServiceDep) -> JobsResponse:
...
def job_detail(service: JobServiceDep, job_id: int) -> JobDetailResponse:
...
def job_status(service: JobServiceDep, job_id: int) -> JobResponse:
